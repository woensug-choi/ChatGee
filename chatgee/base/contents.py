...
def generate_documents(ChatGee_Config):
    ...
    ChatGee_KakaoTalk.insert_carousel_button_url(response, '챗지 구경가기 🧐', 'https://pf.kakao.com/_RxoCkxj')
    ChatGee_KakaoTalk.insert_carousel_button_url(response, '챗지 대화해보기 🤖', 'https://pf.kakao.com/_RxoCkxj/chat')
